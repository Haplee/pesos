...
Most people never control _how_ Claude responds - they just get whatever the model decides to output.
...
_Built by [Drona Gangarapu](https://github.com/drona23) - open to PRs, issues, and profile contributions._
