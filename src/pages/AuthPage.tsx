...
export function AuthPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-6" style={{ backgroundColor: bgColor }}>
      ...
      <form onSubmit={handleSubmit} key={animKey} className="w-full max-w-[300px] space-y-4 fade-in-up" style={{ animationDelay: '0.3s' }}>
        ...
        <div className="fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <button
            ...
            className="absolute right-4 top-1/2 -translate-y-1/2 bg-transparent border-none p-1"
        ...
        {error && (
          <div className="fade-in-up text-center text-sm py-2 rounded-lg" style={{ backgroundColor: 'rgba(255,82,82,0.1)', color: '#ff5252' }}>
            {error}
          </div>
        )}
        
        {message && (
          <div className="fade-in-up text-center text-sm py-2 rounded-lg" style={{ backgroundColor: `${accent}20`, color: accent }}>
            {message}
          </div>
        )}
        ...
        <button
          ...
          className="w-full py-4 rounded-xl text-base flex items-center justify-center gap-3 transition-all hover:scale-[1.02] active:scale-[0.98]"
      ...
      <p className="text-xs mt-8" style={{ color: textMuted }}>Tus datos están seguros</p>
    </div>
  );
}
