...
export function StatsPage() {
  ...
  return (
    <Layout>
      ...
      <div className="bg-[#141418] border border-[rgba(255,255,255,0.06)] rounded-2xl p-4 mb-4 slide-up">
        <div className="text-[1.1rem] font-semibold mb-3">Volumen semanal (8 semanas)</div>
        {totalSets === 0 ? (
          <div className="text-center py-8 text-[#606068]">Sin datos</div>
        ) : (
          <div className="h-[120px]">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={weeklyVolume()}>
                ...
                />
                <Bar dataKey="vol" fill="url(#barGradient2)" radius={[4, 4, 0, 0]} />
                <defs>
      ...
      <div className="bg-[#141418] border border-[rgba(255,255,255,0.06)] rounded-2xl p-4 mb-4 slide-up">
        <div className="text-[1.1rem] font-semibold mb-3">Progresión por ejercicio</div>
        {exerciseOptions.length === 0 ? (
          ...
          <>
            <select
              ...
              className="w-full bg-[#141418] border border-[rgba(255,255,255,0.12)] rounded-xl text-white text-[1rem] p-3 outline-none mb-4"
            >
            ...
            {exerciseStats.length < 2 ? (
              <div className="text-center py-4 text-[#606068]">Necesitas al menos 2 sesiones</div>
            ) : (
