      ...
      <div className="bg-[#141418] border border-[rgba(255,255,255,0.06)] rounded-2xl p-4 slide-up">
        ...
        {sets.length === 0 ? (
          ...
          sets.map((s, i) => {
            ...
            return (
              <div key={i}>
                <div className="grid grid-cols-[36px_1fr_80px_40px] gap-2 items-center mb-2">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="bg-[#141418] border border-[rgba(255,255,255,0.12)] rounded-xl text-white text-[1.1rem] p-3 outline-none w-full"
                    />
                    {isNewPR && (
                      <span className="absolute -top-2 -right-1 text-[0.7rem]">🏆</span>
                    )}
                  </div>
                  <button
                    onClick={() => removeSet(i)}
